...
│   ├── 6_visualisation.py       # Main visualisation figures → figures/eng/
│   └── 7_efficiency_clusters.py # Efficiency-group boxplots
│
...
│   ├── 3_rf_duration.py
│   ├── 4_rf_risk.py
│   ├── 5_efficiency_clusters.py (renamed from 6)
│   └── 6_visualisation.py       # Main visualisation figures → figures/ru/
│
├── experiments/
│   └── empirical_triangle.py    # Sensitivity test: empirical PERT bounds
│
├── figures/
│   ├── eng/                     # English figures (generated by pipeline/)
│   └── ru/                      # Russian figures (generated by pipeline_ru/)
│
├── csvs/                        # Raw Gryzzly CSVs — gitignored, see Data section
