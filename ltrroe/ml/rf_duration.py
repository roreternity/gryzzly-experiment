"""
Модель случайного леса (Random Forest) для предсказания детерминированной
длительности проекта на реальных метриках Gryzzly.
"""
...
plt.xlabel('Фактический срок, дней')
plt.ylabel('Предсказанный срок, дней')
